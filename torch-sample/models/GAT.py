...
from models.NdAttG import NdAttG_Conv
...
class GAT_TYPE(Enum):
    ...
    def get_model(self, in_channels, hidden_channels, out_channels, num_layers, num_heads, dropout, device, saint, use_layer_norm, use_residual, use_resdiual_linear):
        if self is GAT_TYPE.GAT:
            ...
            return GAT(NdAttG_Conv, in_channels, hidden_channels, out_channels, num_layers, num_heads, dropout, device, saint, use_layer_norm, use_residual, use_resdiual_linear)
