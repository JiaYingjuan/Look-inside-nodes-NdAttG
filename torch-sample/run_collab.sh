...
echo "1 head"
echo "w/ val edges"
python ${SCRIPT} --type NdAttG --num_heads 1 --use_valedges_as_input | tee -a "collab_with_valedges_NdAttG_1_heads_results.txt"

echo "model NdAttG"
echo "1 head"
echo "w/o val edges"
python ${SCRIPT} --type NdAttG --num_heads 1 | tee -a "collab_without_valedges_NdAttG_1_heads_results.txt"
...
echo "8 heads"
echo "w/ val edges"
python ${SCRIPT} --type NdAttG --num_heads 8 --use_valedges_as_input | tee -a "collab_with_valedges_NdAttG_8_heads_results.txt"

echo "model NdAttG"
echo "8 heads"
echo "w/o val edges"
python ${SCRIPT} --type NdAttG --num_heads 8 | tee -a "collab_without_valedges_NdAttG_8_heads_results.txt"
