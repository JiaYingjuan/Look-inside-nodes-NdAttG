...
class Sparse_Graph_Model(ABC):
    ...
    def default_params(cls):
        return {
            ...
            'max_epochs': 10000,
            'patience': 25,  # initial 25
            'optimizer': 'Adam',  # Adam
            'learning_rate': 0.001,  # initial 0.001
    ...
    def name(params: Dict[str, Any]) -> str:
        raise NotImplementedError()  # 抽象方法的一个常见实现方式，表示这个方法在抽象基类中没有被具体实现，需要在子类中重写
    ...
    def __init__(self,
        ...
        self.task = task
        self.run_id = run_id
        self.result_dir = result_dir  # 传入的字典保存到实例的属性中。
    ...
    def __make_model(self):
        ...
        with tf.variable_scope("graph_model"):
            ...
            # self.__placeholders['split_nodes_list'] = \
            #     tf.placeholder(dtype=tf.int32, shape=[None], name='split_nodes_list')
        ...
        self.task.make_task_output_model(self.__placeholders, self.__ops)  # 设置与任务相关的输出
    ...
    def __run_epoch(self,
        ...
        for step, batch_data in enumerate(batch_iterator):
            ...
            # batch_data.feed_dict[self.__placeholders['split_nodes_list']] = batch_data.feed_dict[self.__placeholders['graph_nodes_list']]
