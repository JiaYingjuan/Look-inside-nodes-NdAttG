...
echo "model NdAttG"
echo "1 head"
python ${SCRIPT} --type NdAttG --num_heads 1 | tee -a "citation2_NdAttG_1_heads_results.txt"
echo "model GAT"
echo "1 head"
...
echo "model NdAttG"
echo "8 head"
python ${SCRIPT} --type NdAttG --num_heads 8 | tee -a "citation2_NdAttG_8_heads_results.txt"
echo "model GAT"
echo "8 heads"
